package com.scrip0.mvvmrunningapp.services
...
import com.scrip0.mvvmrunningapp.other.Constants.LOCATION_UPDATE_INTERVAL
import com.scrip0.mvvmrunningapp.other.Constants.NOTIFICATION_CHANNEL_ID
import com.scrip0.mvvmrunningapp.other.Constants.NOTIFICATION_CHANNEL_NAME
			...
			if (isTracking.value!!) {
				result.locations.let { locations ->
					for (location in locations) {
						...
						Timber.d("NEW LOCATION: ${LatLng(location.latitude, location.longitude)}")
					}
				}
			}
		}
